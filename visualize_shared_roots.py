...
def create_venn_style_overlap():
    ...
    ax.text(2.3, 7.2, 'YOUTUBE', fontsize=11, fontweight='bold', color='#d35400', ha='center')
    ax.text(2.3, 6.8, 'Post-modernism', fontsize=8.5, ha='center')
    ax.text(2.3, 6.5, 'Neo-Marxism', fontsize=8.5, ha='center')
    ax.text(2.3, 6.2, 'Identity politics', fontsize=8.5, ha='center')
    ax.text(2.3, 5.8, '(726 words)', fontsize=7.5, style='italic', ha='center')
    
    # 2083 label (right disjoint section)
    ax.text(7.7, 7.2, '2083 DOC', fontsize=11, fontweight='bold', color='#2874a6', ha='center')
    ax.text(7.7, 6.8, 'Political Correctness', fontsize=8.5, ha='center')
    ax.text(7.7, 6.5, 'Cultural Marxism', fontsize=8.5, ha='center')
    ax.text(7.7, 6.2, 'Feminism', fontsize=8.5, ha='center')
    ax.text(7.7, 5.9, 'Islam (dominant)', fontsize=8.5, ha='center')
    ax.text(7.7, 5.5, '(41,548 words)', fontsize=7.5, style='italic', ha='center')
